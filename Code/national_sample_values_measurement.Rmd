...
conclusions_list[['Horizontal Collectivism']] <- paste0('Some improvement. Better overall fit, improved invariance, but still has $\\Delta\\text{MFI}$ = .032 (versus .056 previously). Dropping a different item that had lower MIs lead to no improvement in MFI. Dropped ', lnt_item_labels_to_text(drop_items[['hrz_col']]))
