...
drop_items <- list(
  ...
  'hrz_col' = c('ind9'), #biggest MIs, but not bad loading
  ...
  'vrt_ind' = c('ind8'), #some mi, lowest loading
  'bfi_a' = c(''),
  'bfi_c' = c(''),
  'bfi_e' = c(''),
  'bfi_n' = c(''),
...
#-.007 and -.01 
conclusions_list[['Financial Aspirations']] <- ''
conclusions_list[['Materialism']] <- ''
conclusions_list[['Horizontal Collectivism']] <- ''
conclusions_list[['Horizontal Individualism']] <- ''
conclusions_list[['Mature Values Index']] <- ''
conclusions_list[['Unmitigated Self-Interest']] <- ''
conclusions_list[['Vertical Collectivism']] <- ''
conclusions_list[['Vertical Individualism']] <- ''
conclusions_list[['Social Self-Regulation']] <- ''
conclusions_list[['.Conscientiousness']] <- ''
conclusions_list[['..Industriousness']] <- ''
conclusions_list[['..Orderliness']] <- ''
