...
vVarShortNames <- names(vVarNames)
for(fn in seq_along(vVarShortNames)){
  factor_name <- vVarShortNames[[fn]]
...
nullius <- lapply(unique(lnt_scales_df$factor_name), function(var){
