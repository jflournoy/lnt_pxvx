...
```{r  fig.width = 7.5, fig.height = 10, echo = F, warning = F, error = F, eval=T}
library(semPlot)
...
keepcols <- c(1,17,7,2,4,10,11,13,14,16)
...
for(fn in seq_along(factor_names)){
  ...
  invar_mods_listenv[[fn]] <- readRDS(file.path('/data/jflournoy/lnt_pxvx/mi/',
...
knitr::kable(
  mi_metric(invar_mods_listenv[['aspfin']][[2]]),
  digits = 2, row.names = F,
  caption = 'long_metric')

knitr::kable(
  mi_strong(invar_mods_listenv[['aspfin']][[3]]),
  digits = 2, row.names = F,
  caption = 'long_strong')

knitr::kable(
  mi_strict(invar_mods_listenv[['aspfin']][[4]]),
  digits = 2, row.names = F, caption = 'long_strict')

knitr::kable(
  mi_strong(invar_mods_listenv[['aspfin']][[6]]),
  digits = 2, row.names = F, caption = 'group_strong')
```

### Materialism

Not clear if we can trust invariance tests for this scale.
...
options(minimum.value=2.5)
knitr::kable(
  mi_metric(invar_mods_listenv[['hrz_col']][[2]]),
  digits = 2, row.names = F,
  caption = 'long_metric')

knitr::kable(
  mi_strong(invar_mods_listenv[['hrz_col']][[3]]),
  digits = 2, row.names = F,
  caption = 'long_strong')

knitr::kable(
  mi_metric(invar_mods_listenv[['hrz_col']][[5]]),
  digits = 2, row.names = F,
  caption = 'group_metric')

knitr::kable(
  mi_strong(invar_mods_listenv[['hrz_col']][[6]]),
  digits = 2, row.names = F,
  caption = 'group_strong')

knitr::kable(
  mi_strict(invar_mods_listenv[['hrz_col']][[7]]),
  digits = 2, row.names = F,
  caption = 'group_strict')
```
...
options(minimum.value=2.5)
knitr::kable(
  mi_strict(invar_mods_listenv[['hrz_ind']][[4]]),
  digits = 2, row.names = F,
  caption = 'long_strict')
```
...
options(minimum.value=2.5)
knitr::kable(
  mi_strict(invar_mods_listenv[['usi']][[4]]),
  digits = 2, row.names = F,
  caption = 'long_strict')

knitr::kable(
  mi_strong(invar_mods_listenv[['usi']][[6]]),
  digits = 2, row.names = F,
  caption = 'group_strong')
```
...
options(minimum.value=2.5)
knitr::kable(
  mi_metric(invar_mods_listenv[['vrt_col']][[5]]),
  digits = 2, row.names = F,
  caption = 'group_metric')

knitr::kable(
  mi_strong(invar_mods_listenv[['vrt_col']][[6]]),
  digits = 2, row.names = F,
  caption = 'group_strong')
```
...
options(minimum.value=2.5)
knitr::kable(
  mi_strong(invar_mods_listenv[['vrt_ind']][[6]]),
  digits = 2, row.names = F,
  caption = 'group_strong')
```
