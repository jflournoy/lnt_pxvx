...
run_invariance_tests <- function(factor_name, manifest_vec, item_data, fit_measures, group, ...){
  ...
  invar_models <- future.apply::future_lapply(
    all_invar_types,
    function(type){
  ...
  lrt_test <- do.call(function(...){ lavTestLRT(..., model.names = all_invar_types)}, 
                      invar_models)
  
  as_data_frame(lrt_test)
...
these_fit_measures <- c('cfi', 'rmsea', 'rmsea.ci.lower', 'rmsea.ci.upper')

future::plan(future::multiprocess)

some_mods <- run_invariance_tests(factor_name = 'bfi_e', manifest_vec = these_items, item_data = lnt_nat_decades_items, fit_measures = these_fit_measures, group = 'decade_group', missing = 'fiml')
